...
<body class="animsition">
            ...
            <div class="top-bar">
                <div class="content-topbar flex-sb-m h-full container">
                    ...
                    <div class="right-top-bar flex-w h-full">
                        ...
                        <a href="logout.php" class="flex-c-m trans-04 p-lr-25" style="text-decoration: none;">
                        ...
                        <div class="text-center">
                            <div class="d-flex justify-content-center">
                                ...
                                ?>
                                    ...
                                    <img style="margin-top:-120px; width: 300px; height: 300px;" class="img rounded-circle " id="profileimage" src="<?php echo $result['profileimage'] ?>" alt="">
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-offset-2 col-sm-8" style=" font:20px bold; text-align: center;">
                            <div>
                                ...
                                <P class="details"><?php echo "Your Username : " . $result['username']  ?></P> <br>
                                <P class="details"><?php echo "Your Email : " . $result['email']  ?></P> <br>
                                <P class="details"><?php echo "Your Phone : " . $result['phone']  ?></P> <br>

                                <P class="details"><?php echo "Your Register Date : " . $result['registerdate']  ?></P> <br>
    ...
    <div class="service">
        <div class="container">
            ...
            <a href="requestpic.php" class="m-t-20 flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 m-b-50">
                Schedule Pickup
            </a>
            ...
            <div class="center-div">
                <div class="table-responsive">
                    <table class="table table-bordered border-primary text-center">
                        ...
                        <?php
                        // $EMAIL = $email;
                        $q = "SELECT * FROM requestpickup where emailaddress = '$email'";
