    ...
    <div class="container">
        ...
        <div class="col-md-7 col-lg-8">
          <div class="p-t-7 p-r-85 p-r-15-lg p-r-0-md">
            <h3 class="mtext-111 cl2 p-b-16">
              Plastic Recycle Management
            </h3>

            <p class="stext-113 cl6 p-b-26">
              We use the following two-step process: <br>

              <b>Step One:</b> Sorting plastics automatically or with a manual sort to make sure all the contaminants are removed from the plastic waste stream. <br>

              <b>Step Two: </b> Melting down plastics directly into a new shape or shredding into flakes then melting down before being finally processed into granulates. <br>
            </p>
      ...
      <div class="row">
          ...
          <div class="p-t-7 p-l-85 p-l-15-lg p-l-0-md">
            ...
            <div class="bor16 p-l-29 p-b-9 m-t-22">
              <p class="stext-114 cl6 p-r-40 p-b-11">
                To have initiative that aims to establish environment-friendly plastic waste disposal solutions.
              </p>
        ...
        <div class="order-md-1 col-11 col-md-5 col-lg-4 m-lr-auto p-b-30">
          <div class="how-bor2">
            <div class="hov-img0">
              <img src="images/service-4-1.jpg" alt="IMG">
            </div>
          </div>
        </div>
