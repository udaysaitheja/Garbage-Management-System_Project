...
-->
  ...
  <section class="bg0 p-t-75 p-b-120">
		<div class="container">
            ...
            Paper Recycle Management
						</h3>

						<p class="stext-113 cl6 p-b-26">
            <b>1: Thrown away.</b> Paper waste is deposited into the appropriate bins, ready to be collected. <br>

              <b>2: Transported.</b> The paper waste is collected by carrier and dropped off at a recycling facility. <br>

<b>3: Separation.</b> Here it will be separated. <br>

<b>4: Washing.</b>  Here paper is cleaned. This process removes any ink, glue or staples from the paper. <br>

<b>5: Spreading.</b> The slurry is spread out, ready to be cut into fine sheets for use. <br>

<b>6: Redistribution.</b> The recycled paper is then ready for reuse or resale!
						</p>
			...
			<div class="row">
              ...
              To promote increased paper recovery for recycling by raising awareness about the importance of recycling, educating key stakeholders about the success of the voluntary paper recovery system, and providing tools and resources to help communities, businesses and schools start or improve paper recycling programs.
				...
				<div class="order-md-1 col-11 col-md-5 col-lg-4 m-lr-auto p-b-30">
					<div class="how-bor2">
						<div class="hov-img0">
							<img src="images/service-5-1.jpg" alt="IMG">
						</div>
					</div>
				</div>
