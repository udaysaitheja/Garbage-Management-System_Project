...
-->
  ...
  <section class="bg0 p-t-75 p-b-120">
		<div class="container">
            ...
            <b>Reuse</b> <br>
            <b>Return to supplier</b> <br>
            <b>Sale to another Company</b> <br>
            <b>Sale to dealer</b> <br>
            <b>Sale to Customer</b> <br>
						</p>
			...
			<div class="row">
				<div class="order-md-2 col-md-7 col-lg-8 p-b-30">
					<div class="p-t-7 p-l-85 p-l-15-lg p-l-0-md">
						...
						<p class="stext-113 cl6 p-b-26">
						Alloys scrap metal mission and values focus on superior service, exceptional worldwide marketing and environmental sensitivity.
						</p>

						<div class="bor16 p-l-29 p-b-9 m-t-22">
							<p class="stext-114 cl6 p-r-40 p-b-11">
              Our Mission is to implement Swachh Bharat Mission (Urban), Swachh Bharat Mission (Rural) and Communication and Capacity Development Unit (CCDU) in the State.
							</p>
				...
				<div class="order-md-1 col-11 col-md-5 col-lg-4 m-lr-auto p-b-30">
					<div class="how-bor2">
						<div class="hov-img0">
							<img src="images/service-6-1.jpg" alt="IMG">
						</div>
					</div>
				</div>
