	...
	<section class="bg0 p-t-75 p-b-120">
		<div class="container">
            ...
            Your garbage gets picked up.
						...
						<p class="stext-113 cl6 p-b-26">
						With most waste collection, disposal and recycling companies, the job ends there.
						</p>
					</div>
				</div>
			...
			<div class="row">
              ...
              We provide residential solid waste and recycling services to thousands of families and neighborhoods every day.
							</p>
				...
				<div class="order-md-1 col-11 col-md-5 col-lg-4 m-lr-auto p-b-30">
					<div class="how-bor2">
						<div class="hov-img0">
							<img src="images/service-1-1.jpg" alt="IMG">
						</div>
					</div>
				</div>
