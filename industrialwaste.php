  ...
  <!-- header ends -->
	...
	<section class="bg0 p-t-75 p-b-120">
		<div class="container">
            ...
            <b>Segregation and Recycling:  </b> The first step in your industrial waste management program is to identify which items can be recycled, and set up recycling bins. Recycling centers can handle glass, paper, plastic, scrap metal recycling, cardboard recycling, food waste recycling, and electronics recycling.
						</p>

						<p class="stext-113 cl6 p-b-26">
           <b>Using of Landfills: </b> The only waste that should be sent to landfills is that which is non-hazardous, non-recyclable, and non-compostable.
						</p>

						<p class="stext-113 cl6 p-b-26">
					<b>Composting: </b>This composting process turns organic waste into fertilizer.
						</p>
					</div>
				</div>
			...
			<div class="row">
				<div class="order-md-2 col-md-7 col-lg-8 p-b-30">
					<div class="p-t-7 p-l-85 p-l-15-lg p-l-0-md">
						...
						<p class="stext-113 cl6 p-b-26">
						To manage solid waste as a resource, promoting sustainable, environmentally sound and cost effective practices through an integrated system of waste reduction, reuse, recycling, innovative technology, customer service and education.
						</p>

						<div class="bor16 p-l-29 p-b-9 m-t-22">
							<p class="stext-114 cl6 p-r-40 p-b-11">
              We are here to reduce the amount of waste by promoting individual and corporate responsibility.
							</p>
				...
				<div class="order-md-1 col-11 col-md-5 col-lg-4 m-lr-auto p-b-30">
					<div class="how-bor2">
						<div class="hov-img0">
							<img src="images/service-2-1.jpg" alt="IMG">
						</div>
					</div>
				</div>
      ...
      <a href="login.php" class="m-t-20 flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
                  Schedule Pickup
                </a>
